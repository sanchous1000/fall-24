...
# Визуализация данных
### Датасет 1: Wine Clustering <link>
...
По дендрограммам можно определить оптимальное число кластеров: для WineClustering - 2 кластера, для Customers - тоже 2.
